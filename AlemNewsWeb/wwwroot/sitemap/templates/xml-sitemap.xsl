  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <script type="text/javascript" src="/sitemap/javascript/jquery.min.js"></script>
        <script type="text/javascript" src="/sitemap/javascript/jquery.tablesorter.min.js"></script>
